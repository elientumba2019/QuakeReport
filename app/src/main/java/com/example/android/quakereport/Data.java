...
public class Data {
    ...
    private List<EarthQuake> getResults() throws JSONException {

        List<EarthQuake> list = new LinkedList<>();

        JSONObject responseObject = new JSONObject(response);
        JSONArray array = responseObject.optJSONArray("features");

        for(int c = 0 ; c < array.length() ; c++){

            JSONObject earthQuake = array.optJSONObject(c);
            ...
            String time = getTime(properties.optLong("time"));
